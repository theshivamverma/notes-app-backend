...
async function signupUser(req, res){
    try {
        ...
        res.status(400).json({ success: false, message: "Error signing up user", errorMessage: error.message })
    }
}
...
module.exports = { loginUser, signupUser, checkEmailValidity, checkUsernameValidity }
